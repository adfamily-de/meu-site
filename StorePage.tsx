      ...
      <section className="bg-missionary-green py-20">
        <div className="container-missionary">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <ShoppingBag className="w-12 h-12 text-missionary-gold mb-4" />
            ...
            <Dialog open={isCartOpen} onOpenChange={setIsCartOpen}>
              <DialogTrigger asChild>
                <button className="relative flex items-center gap-2 px-6 py-3 bg-white text-missionary-green rounded-lg hover:bg-missionary-cream transition-colors self-start">
                  <ShoppingCart className="w-5 h-5" />
                  Carrinho
                  {getCartItemCount() > 0 && (
                    <span className="absolute -top-2 -right-2 w-6 h-6 bg-missionary-orange text-white text-xs rounded-full flex items-center justify-center">
                      {getCartItemCount()}
                    </span>
                  )}
                </button>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProducts.map((product, index) => (
              <ScrollReveal key={product.id} delay={index * 100}>
                <div className="bg-white rounded-2xl overflow-hidden shadow-missionary hover:shadow-missionary-lg transition-all duration-300 hover:-translate-y-1 group">
